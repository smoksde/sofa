...
#include "lumina/viewport.hpp"
#include "lumina/defines.hpp"
#include "lumina/utils.hpp"
...
int main()
{
    ...
    lumina::Camera3D camera(glm::vec3(0.0f, 0.0f, 3.0f), glm::vec3(0.0f, 0.0f, -1.0f), glm::vec3(0.0f, 1.0f, 0.0f),
