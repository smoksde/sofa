...
The optimizer can query scores for different parameter sets that describe, how
the sofa has to be moved through space over time.
The score just deliver a measurement for the area of the sofa that got through.
